        ...
        {collapsed ? (
          ...
          <>
            <Link to="/app" style={{ display: 'flex', alignItems: 'center', gap: 10, textDecoration: 'none' }}>
              <AtlasLogo size={30} />
              <div>
                <p style={{ fontSize: 14, fontWeight: 800, margin: 0, lineHeight: 1, fontFamily: "'Inter', system-ui, sans-serif", letterSpacing: '0.12em', background: 'linear-gradient(135deg,#c9a84c,#f5e09a,#c9a84c)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>ATLAS</p>
                <p style={{ fontSize: 9, fontWeight: 500, letterSpacing: '0.1em', textTransform: 'uppercase', color: 'var(--sidebar-label)', margin: '2px 0 0', fontFamily: "'Inter', system-ui, sans-serif" }}>Reselling, Quantified</p>
              </div>
            </Link>
      ...
      <main className="layout-main"
        ...
        <div className="layout-topbar-mobile"
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            <AtlasLogo size={26} />
            <span style={{ fontSize: 14, fontWeight: 800, fontFamily: "'Inter', system-ui, sans-serif", letterSpacing: '0.12em', background: 'linear-gradient(135deg,#c9a84c,#f5e09a)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>ATLAS</span>
          </div>
        </div>
