...
export default async function handler(req, res) {
  ...
  // DEBUG: Log env variables to console
  console.log('DEBUG: BASE44_API_KEY exists?', !!process.env.BASE44_API_KEY);
  console.log('DEBUG: BASE44_API_KEY value:', process.env.BASE44_API_KEY ? 'SET' : 'NOT SET');
  console.log('DEBUG: DISCORD_CLIENT_ID:', process.env.DISCORD_CLIENT_ID);
  console.log('DEBUG: BASE44_FUNCTION_URL:', process.env.BASE44_FUNCTION_URL);
  ...
  try {
    ...
    // DEBUG: Log before calling Base44
    console.log('DEBUG: About to call Base44 with api_key:', process.env.BASE44_API_KEY ? 'YES' : 'NO');
    console.log('DEBUG: BASE44_FUNCTION_URL:', process.env.BASE44_FUNCTION_URL);
    ...
    console.log('DEBUG: Backend response status:', backendRes.status);
    console.log('DEBUG: Backend response data:', backendData);
