    ...
    <div style={{ display:'flex', flexDirection:'column', gap:20 }}>
          ...
          return (
            <div key={stat.label} style={{ ...sectionCard, padding:16, borderTop:`3px solid ${stat.accentColor}` }}>
              <div style={{ display:'flex', alignItems:'center', gap:8, marginBottom:8 }}>
                ...
                <p style={{ fontSize:8, fontWeight:700, letterSpacing:'0.14em', textTransform:'uppercase', color:'var(--ink-dim)', fontFamily:"var(--font-serif)", margin:0 }}>{stat.label}</p>
              </div>
      ...
      <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:16 }}>
        ...
        <div style={{ ...sectionCard, padding:20 }}>
          <p style={{ fontSize:8, fontWeight:700, letterSpacing:'0.14em', textTransform:'uppercase', color:'var(--ink-dim)', marginBottom:16, fontFamily:"var(--font-serif)" }}>Spend & Est. Cashback by Card</p>
          {barData.length===0
        ...
        {/* Pie donut */}
        <div style={{ ...sectionCard, padding:20 }}>
          <p style={{ fontSize:8, fontWeight:700, letterSpacing:'0.14em', textTransform:'uppercase', color:'var(--ink-dim)', marginBottom:16, fontFamily:"var(--font-serif)" }}>Spend Distribution</p>
      ...
      <div style={{ ...sectionCard, overflow:'hidden' }}>
        <div style={{ padding:'14px 20px', borderBottom:'1px solid var(--parch-line)', background:'var(--parch-warm)' }}>
          <p style={{ fontSize:8, fontWeight:700, letterSpacing:'0.14em', textTransform:'uppercase', color:'var(--ink-dim)', margin:0, fontFamily:"var(--font-serif)" }}>Card Performance Table</p>
        </div>
