...
export default function POStatsBar({ orders }) {
  ...
  return (
    <div className="space-y-3 mb-6">
      ...
      {/* Total Profit Card */}
      <div className="bg-green-50 border border-green-200 rounded-lg p-4 max-w-xs overflow-hidden">
        <div className="flex items-center gap-3 min-w-0">
          <DollarSign className="h-5 w-5 flex-shrink-0 text-slate-400" />
          <div className="min-w-0 flex-1">
            <p className="text-xs text-slate-600">Total Profit</p>
            <p className="text-xl font-bold mt-0.5 text-green-600 break-words">
