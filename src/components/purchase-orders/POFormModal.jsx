...
import { Plus, X, CreditCard, Package, ShoppingCart, Truck } from 'lucide-react';
            ...
            <div className="grid grid-cols-4 gap-3 mb-3 items-end">
              ...
              <div className="space-y-1">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <Input className="bg-white text-center text-base font-medium h-10" type="number" min="1"
