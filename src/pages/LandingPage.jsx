...
export default function LandingPage() {
  ...
  return (
    <div style={{ background: "#060503", minHeight: "100vh", color: "#f0ece4", overflowX: "hidden", fontFamily: "'DM Sans', sans-serif" }}>
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,500;0,600;0,700;1,500&family=DM+Sans:wght@300;400;500;600;700&family=Marcellus&display=swap');
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .nl { color:#f0ece4; text-decoration:none; font-size:13px; font-weight:400;
      ...
      <section style={{ padding:"100px 48px", background:"rgba(10,9,6,0.85)", borderTop:"1px solid #C4922E22", borderBottom:"1px solid #C4922E22" }} className="sp">
        <div style={{ maxWidth:1200, margin:"0 auto" }}>
          <div style={{ textAlign:"center", marginBottom:60 }}>
            ...
            <h2 className="serif" style={{ fontSize:44, fontWeight:600, lineHeight:1.1, marginBottom:14, color:"#f0ece4" }}>
              Everything You Need.<br/>All in One Place.
            </h2>
            <p style={{ fontSize:14, color:"#f0ece4", maxWidth:460, margin:"0 auto", lineHeight:1.7, fontWeight:300 }}>
          ...
          <div className="fg" style={{ display:"grid", gridTemplateColumns:"repeat(4,1fr)", gap:14 }}>
            {FEATURES.map((f, i) => (
              <div key={f.title} className={`fc fu d${i+1} ${visible?"in":""}`}>
                ...
                <div style={{ fontSize:12, color:"#f0ece4", lineHeight:1.65, fontWeight:300 }}>{f.desc}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div style={{ maxWidth:1200, margin:"0 auto" }}>
          <div className="wg" style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:80, alignItems:"center" }}>
            <div>
              ...
              <h2 className="serif" style={{ fontSize:44, fontWeight:600, lineHeight:1.1, marginBottom:20, color:"#f0ece4" }}>
                Not Another<br/><span style={{ color:"#C4922E" }}>Spreadsheet Tool.</span>
              </h2>
              <p style={{ fontSize:14, color:"#f0ece4", lineHeight:1.8, marginBottom:36, fontWeight:300, maxWidth:400 }}>
      ...
      <section style={{ padding:"110px 48px", background:"rgba(6,5,4,0.82)", textAlign:"center", position:"relative", overflow:"hidden" }} className="sp">
        ...
        <div style={{ maxWidth:580, margin:"0 auto", position:"relative", zIndex:1 }}>
          ...
          <p style={{ fontSize:15, color:"#f0ece4", marginBottom:38, lineHeight:1.7, fontWeight:300 }}>
        ...
        <div style={{ maxWidth:1200, margin:"0 auto" }}>
          <div className="ftg" style={{ display:"grid", gridTemplateColumns:"2fr 1fr 1fr 1fr", gap:48, marginBottom:44 }}>
            <div>
              ...
              <p style={{ fontSize:13, color:"#f0ece4", lineHeight:1.65, maxWidth:220, fontWeight:300, marginBottom:18 }}>
          ...
          <div style={{ borderTop:"1px solid #C4922E0a", paddingTop:22, display:"flex", justifyContent:"space-between", alignItems:"center", flexWrap:"wrap", gap:10 }}>
            ...
            <div style={{ display:"flex", gap:22 }}>
              {["Privacy Policy","Terms of Service"].map(l => (
                <a key={l} href="#" style={{ fontSize:12, color:"#f0ece4", textDecoration:"none", transition:"color 0.2s" }}
                  onMouseEnter={e=>e.currentTarget.style.color="#C4922E"}
                  onMouseLeave={e=>e.currentTarget.style.color="#f0ece4"}>{l}</a>
              ))}
            </div>
          </div>
        </div>
