    ...
    <div style={{ background: "#080706", minHeight: "100vh", color: "#f0ece4", overflowX: "hidden", fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <nav style={{
        ...
        <div style={{ display:"flex", alignItems:"center", gap:10 }}>
          <AtlasLogo size={30}/>
          <span className="serif" style={{ fontSize:16, fontWeight:600, letterSpacing:"0.22em", color:"#f5e09a" }}>ATLAS</span>
        </div>
          ...
          <div className="ftg" style={{ display:"grid", gridTemplateColumns:"2fr 1fr 1fr 1fr", gap:48, marginBottom:44 }}>
            <div>
              <div style={{ display:"flex", alignItems:"center", gap:10, marginBottom:12 }}>
                <AtlasLogo size={26}/>
                <span className="serif" style={{ fontSize:14, fontWeight:600, letterSpacing:"0.2em", color:"#f5e09a" }}>ATLAS</span>
              </div>
